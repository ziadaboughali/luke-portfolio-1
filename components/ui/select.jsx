...
const SelectTrigger = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        // changed to h-[44px] bg-primary
        'flex h-[44px] w-full items-center justify-between rounded-md border border-white/20 bg-primary px-3 py-2 text-base text-white/60 placeholder:text-white/60',
        className
      )}
      {...props}
    >
